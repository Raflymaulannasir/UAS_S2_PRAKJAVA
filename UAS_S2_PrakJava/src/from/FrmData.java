...
public class FrmData extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            String update = "UPDATE datakendaraan SET NamaPemilik = '" + txtNamaPemilik.getText() +
                    "', AlamtPemilik = '" + txtAlamatPemilik.getText() +
                    "', MerkKendaraan = '" + txtMerkKendaraan.getText() +
                    "', JenisKendaraan '" + txtJenisKendaraan.getText() +
                    "', WarnaKendaraan '" + txtWarnaKendaraan.getText() +
